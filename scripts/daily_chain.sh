...
echo "[5/9] 生成四层内容（一句话/总结/原文翻译）"
$PY scripts/build_four_layers.py all || echo "[WARN] 四层生成失败，沿用上一轮"
$PY scripts/refetch_l3.py || echo "[WARN] L3 重抓失败，下轮重试"

echo "[6/9] 文献三层重建（吃进新译文）"
